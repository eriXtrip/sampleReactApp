...
export const LESSON_CARDS = [
  ...
  { id: '2', title: 'Topic 1', type: 'ppt', status: true, shortDescription: 'Bailey, C.S. (1906). The legend of the dipper. Accessed via CommonLit.', file: 'THE LEGEND OF THE DIPPER.pptx', MIME: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', size: '0.32 MB',  content: 'https://drive.google.com/uc?id=1o-Jw-8AamQPX2cy6gV57cfj_likUMGAW&export=download' },
  { id: '3', title: 'Lesson 2', type: 'pdf', status: true, shortDescription: 'A comprehensive PDF guide for the second lesson.',file: 'Chapter1.pdf', MIME: 'application/pdf', size: '34.21 MB',  content: 'https://drive.google.com/uc?id=10GYZ4QZ_8lsDpgUdJ2J9ILQv97rmj28L&export=download' },
  ...
  { id: '13', title: 'Elements of the Story Rap', type: 'link', status: true, shortDescription: 'Bloom, J. (2017, April 7). Elements of the story rap [Video]. YouTube.', content: 'https://www.youtube.com/watch?v=0eY-fkyacW0&t=197s' },
  { id: '14', title: 'Short Story Elements', type: 'link', status: true, shortDescription: 'Hess, N. (2014, September 9). Short story elements [Video]. YouTube.', content: 'https://www.youtube.com/watch?v=VDmhl-SU5Yk&t=42s' },
  { id: '15', title: 'Plot Mountain! The Plot Diagram Song', type: 'link', status: true, shortDescription: 'Scratch Garden. (2015, November 15). Plot mountain! The plot diagram song. YouTube.', content: 'https://www.youtube.com/watch?v=NpWHZJZQDSE&t=128s' },
];
