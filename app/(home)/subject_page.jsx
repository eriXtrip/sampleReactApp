...
import { View, StyleSheet, Dimensions, TouchableOpacity, Image, Animated, ImageBackground } from 'react-native';
...
const SubjectPage = () => {
  ...
  const renderLessonCard = ({ item }) => (
    <TouchableOpacity>
      <View style={[styles.cardBox, { backgroundColor: theme.background, borderColor: theme.cardBorder }] }>
